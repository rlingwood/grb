...
chost = host(optical, xray, mw, zhost)
...
wl = wl[fluxwn > 0]
fittedflux = fittedflux[fluxwn > 0]
fluxwn = fluxwn[fluxwn > 0]
...
print(round(outputchi, 2))
print(round(param[0], 2))
print(round(param[0]-hostebv, 2))
